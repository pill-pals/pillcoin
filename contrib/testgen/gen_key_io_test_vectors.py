...
bech32_templates = [
  ...
  ('pill',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('pill',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('pill',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tpill',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tpill',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tpill',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rpill',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rpill',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rpill', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tpill',  17, 32, False, False, False),
  ('rpill',  3,  1, False, False, False),
  ('pill',   15, 41, False, False, False),
  ('tpill',  0, 16, False, False, False),
  ('rpill',  0, 32, True,  False, False),
  ('pill',   0, 16, True,  False, False),
  ('tpill',  0, 32, False, True,  False),
  ('rpill',  0, 20, False, False, True)
]
