# Support for Output Descriptors in Pillcoin Core

Since Pillcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `pill1...` for mainnet or `tpill1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Pillcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Pillcoin Core wallets, a convenience function `combo` is
