...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pillcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pillcoin-tx [options] <hex-tx> [commands]  Update hex-encoded pillcoin transaction\n" +
            "or:     pillcoin-tx [options] -create [commands]   Create hex-encoded pillcoin transaction\n" +
            "\n";
