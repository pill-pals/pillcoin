...
{
    const char* pszTimestamp = "CNET 22/May/2021 Apple's Tim Cook grilled by judge overseeing Epic's Fortnite trial";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 4.2 * 24 * 60 * 60; // 4.20 days
        ...
        genesis = CreateGenesisBlock(1621710724, 2085126912, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaf2cdfbb4160a17665007544a4e4bd6f83c7c3bc10c17590615f693708b3ea65"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc64975e001068f51abdc57c19ff2a3bcbd0bc202d09300752fa0b8f80004679"));
        ...
        //vSeeds.emplace_back("seed-a.pillcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.pillcointools.com");
        //vSeeds.emplace_back("dnsseed.pillcoinpool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x50, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x50, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = {
            {
                {  0, uint256S("0xaf2cdfbb4160a17665007544a4e4bd6f83c7c3bc10c17590615f693708b3ea65")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.pillcointools.com");
        vSeeds.emplace_back("seed-b.pillcoin.loshan.co.uk");
