...
const char * const BITCOIN_CONF_FILENAME = "pillcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pillcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pillcoin";
#else
    // Unix
    return pathRet / ".pillcoin";
#endif
#endif
}
