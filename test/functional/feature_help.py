...
"""Verify that starting pillcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pillcoin with -h for help text")
        ...
        self.log.info("Start pillcoin with -version for version information")
        ...
        self.log.info("Start pillcoind with -fakearg to make sure it does not start")
